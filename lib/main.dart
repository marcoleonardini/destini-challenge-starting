...
String _story = _brain.getStory();
String _choice1 = _brain.getChoice1();
String _choice2 = _brain.getChoice2();
              ...
              Expanded(
                ...
                child: FlatButton(
                  onPressed: () {
                    ...
                    _brain.nextStory(1);
                    _story = _brain.getStory();
                    _choice1 = _brain.getChoice1();
                    _choice2 = _brain.getChoice2();
                    setState(() {});
                  },
                  color: Colors.red,
                  child: Text(
              ...
              Expanded(
                ...
                child: Visibility(
                  ...
                  child: FlatButton(
                    ...
                    color: Colors.blue,
                    child: Text(
                      //DONE: Step 14 - Use the storyBrain to get the text for choice 1.
                      _choice2,
                      style: TextStyle(
                        fontSize: 20.0,
                      ),
